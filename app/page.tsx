      ...
      <Container>
        <section className="flex min-h-[calc(80vh-4rem)] flex-col justify-center py-24 sm:py-32">
          ...
          <p className="mt-8 max-w-2xl text-xl leading-9 text-zinc-600 dark:text-zinc-400 sm:text-2xl">
            I turn ambiguous problems into shipped solutions. Currently focused
            on fintech, supply chain, and workforce platforms.
          </p>
        </section>
      </Container>
        ...
        <section className="py-16 sm:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-400">
              I&apos;m a Product Manager with experience across fintech,
              logistics, and workforce platforms. I work closely with
              engineering, design, and stakeholders to clarify requirements,
              ship MVPs, and iterate on data.
            </p>
            <Link
              href="/about"
